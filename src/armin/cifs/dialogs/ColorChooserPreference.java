...
public class ColorChooserPreference extends Preference {
	...
	@Override protected void onClick() {
		new ColorChooserDialog(getContext(), value, new ColorChooserDialog.OnAmbilWarnaListener() {
			@Override public void onOk(ColorChooserDialog dialog, int color) {
			...
			@Override public void onCancel(ColorChooserDialog dialog) {
				// nothing to do
			}
		}).show();
	}
