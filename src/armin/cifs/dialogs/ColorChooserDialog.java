 ...
 * http://code.google.com/p/yuku-android-util/source/browse/AmbilWarna/ 
 */
...
public class ColorChooserDialog {
        public interface OnAmbilWarnaListener {
                void onCancel(ColorChooserDialog dialog);
                void onOk(ColorChooserDialog dialog, int color);
        }
        ...
        /**
         * create a ColorChooserDialog. call this only from OnCreateDialog() or from a background thread.
         *
         * @param context
         *            current context
         * @param color
         ...
         */
        public ColorChooserDialog(final Context context, int color, OnAmbilWarnaListener listener) {
                ...
                dialog = new AlertDialog.Builder(context)
                        .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                                @Override public void onClick(DialogInterface dialog, int which) {
                                        if (ColorChooserDialog.this.listener != null) {
                                                ColorChooserDialog.this.listener.onOk(ColorChooserDialog.this, getColor());
                                        }
                                }
                        })
                        .setNegativeButton(android.R.string.cancel, new DialogInterface.OnClickListener() {
                                @Override public void onClick(DialogInterface dialog, int which) {
                                        if (ColorChooserDialog.this.listener != null) {
                                        	ColorChooserDialog.this.listener.onCancel(ColorChooserDialog.this);
                                        }
                                }
                        })
